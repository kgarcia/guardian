...
class CentrosControllerTest < ActionController::TestCase
  ...
  test "should create centro" do
    assert_difference('Centro.count') do
      post :create, centro: { codigo: @centro.codigo, electores: @centro.electores, mesas: @centro.mesas, nombre: @centro.nombre, parroquia_id: @centro.parroquia_id, testigos: @centro.testigos }
    end
  ...
  test "should update centro" do
    patch :update, id: @centro, centro: { codigo: @centro.codigo, electores: @centro.electores, mesas: @centro.mesas, nombre: @centro.nombre, parroquia_id: @centro.parroquia_id, testigos: @centro.testigos }
    assert_redirected_to centro_path(assigns(:centro))
  end
